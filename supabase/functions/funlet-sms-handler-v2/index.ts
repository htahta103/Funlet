...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // V2 TIMING: Pre-assistant processing phase
    const preAssistantStart = Date.now();
  ...
  if (cleanMessage === 'reset') {
    ...
    // V2 TIMING: Assistant processing phase
    ...
    // V2 TIMING: Assistant processing completed
    ...
    // V2 TIMING: Final performance summary
    const totalTime = Date.now() - startTime;
    const preAssistantTime = assistantStart - preAssistantStart;
    const assistantTime = assistantEnd - assistantStart;
    const postAssistantTime = totalTime - (assistantEnd - startTime);
    
    console.log(`🏁 V2 [${totalTime}ms] Request completed successfully`);
    console.log(`⏱️  V2 TIMING BREAKDOWN:`);
    console.log(`   📊 Pre-assistant: ${preAssistantTime}ms`);
    console.log(`   🤖 Assistant: ${assistantTime}ms`);
    console.log(`   📤 Post-assistant: ${postAssistantTime}ms`);
