#!/bin/bash
# AS-043: Stop Auto Sync while running
# Expected: Organizer stops Auto Sync, Auto Sync stops and archives
...
if validate_test "AS-043" "$response" "stopped\|archived\|cancelled" "" "$start_time"; then
  # Cleanup
