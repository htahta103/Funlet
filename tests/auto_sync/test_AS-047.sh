#!/bin/bash
# AS-047: Auto Sync Check selection
# Expected: Organizer selects Auto Sync, correct management menu shown
...
if validate_test "AS-047" "$response" "send invites\|stop\|1.*\|2.*" "" "$start_time"; then
  # Cleanup
